eng = {
    ...
    'args':{
        ...
        'topgg': {
            ...
            'dsc':'''
Thank you so much for choosing to vote for me {0}
...
a support server, it's all down here''',
        ...
        'actions': {
            ...
            'actionhug': 'hugged',
            'actionslap': 'slapped',
            'actionpat': 'made a cafuné in',
            'actionpunch': 'punched',
            'actionbite': 'he bit',
            'actionlick': 'licked',

            'return': 'Click the 🔁 to give back',
...
''' ,
        ...
        'mod': {
            ...
            'content':'''
Ban - (Ban members) - Ban members from your server
...
'''
        ...
        'suport': {
            ...
            'content': '''
Suggest - Send a suggestion to my owner
...
'''
        ...
        'image':{
            ...
            'content':'''
Cat - Send an image of a random cat
AchievementMine - Create a minecraft achievement
